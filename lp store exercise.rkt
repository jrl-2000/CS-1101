...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |lp store exercise|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
;; LP Store

...
;;Problem 3 with higher order functions
...
;; consumes a list of borrowers and produces a list of the names of the
;; borrowers for whom there are not yet any funds pledged

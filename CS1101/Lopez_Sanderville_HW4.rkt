...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname Lopez-Sanderville-HW4) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;;Problem 4
(define customer6 (make-customer 501 CONTACT1 185.8 L3 false false))
...
;;gonna make a call to the helper function from problem 7 (charge-amount) because it helps for this funnction (Probelm 8) as well.
...
(check-expect (customers-with-outstanding-charges customer6) empty)
...
;; Consumes a BST, a ccn, and contact info, and produces a new tree with the
;; same data except the given ccn's credit limit is increased by the given amount


;; fcn definition


(define (increase-limit atn ccn increase)
   (cond [(boolean? atn) false]
         [(customer? atn)   (make-customer
                                 (customer-card-number atn)
                                 (customer-contact atn)
                                 (if (= ccn (customer-card-number atn))
                                      (+ increase (customer-limit atn))
                                      (customer-limit atn))
                                 (customer-charges atn)
                                 (increase-limit (customer-left atn) ccn increase)
                                 (increase-limit (customer-right atn) ccn increase)
                             )]))


;; tests for main fcn
(check-expect (increase-limit false 1001 500) false)

(check-expect (increase-limit customer1 1001 500) (make-customer 1001 CONTACT1 685.8 L1 false false))

(check-expect (increase-limit customer3 1001 500) (make-customer 2049 (make-contact "Nate" "13 Smith St" "nate01@gmail.com") 403.4
                        (list (make-charge "Software" 199) (make-charge "Gaming" 849) (make-charge "Theater" 20))  (make-customer 1001 CONTACT1 685.8 L1 false false) false))

(check-expect (increase-limit customer4 5029 500)
                        (make-customer 4049 (make-contact "Zack" "26 Smith St" "zack01@gmail.com") 608.7
                        (list (make-charge "Software" 269) (make-charge "Video Games" 549) (make-charge "Groceries" 20))  false (make-customer 5029 CONTACT2 703.9 L2 false false)))

(check-expect (increase-limit customer5 5029 500)
                        (make-customer 3011 (make-contact "Billy" "29 Smith St" "billy01@gmail.com") 909.7
                        (list (make-charge "Gaming" 849) (make-charge "Theater" 20))  customer3 (make-customer 4049 (make-contact "Zack" "26 Smith St" "zack01@gmail.com") 608.7
                        (list (make-charge "Software" 269) (make-charge "Video Games" 549) (make-charge "Groceries" 20))  false (make-customer 5029 CONTACT2 703.9 L2 false false))))
                           
(check-expect (increase-limit customer5 1001 500)
                        (make-customer 3011 (make-contact "Billy" "29 Smith St" "billy01@gmail.com") 909.7
                        (list (make-charge "Gaming" 849) (make-charge "Theater" 20))  (make-customer 2049 (make-contact "Nate" "13 Smith St" "nate01@gmail.com") 403.4
                        (list (make-charge "Software" 199) (make-charge "Gaming" 849) (make-charge "Theater" 20))   (make-customer 1001 CONTACT1 685.8 L1 false false) false) customer4))
                             
(check-expect (increase-limit customer5 2049 500)
                        (make-customer 3011 (make-contact "Billy" "29 Smith St" "billy01@gmail.com") 909.7
                        (list (make-charge "Gaming" 849) (make-charge "Theater" 20))
                        (make-customer 2049 (make-contact "Nate" "13 Smith St" "nate01@gmail.com") 903.4
                        (list (make-charge "Software" 199) (make-charge "Gaming" 849) (make-charge "Theater" 20))  customer1 false) customer4))
                            
(check-expect (increase-limit customer5 4049 500)
                        (make-customer 3011 (make-contact "Billy" "29 Smith St" "billy01@gmail.com") 909.7
                        (list (make-charge "Gaming" 849) (make-charge "Theater" 20))  customer3
                        (make-customer 4049 (make-contact "Zack" "26 Smith St" "zack01@gmail.com") 1108.7
                        (list (make-charge "Software" 269) (make-charge "Video Games" 549) (make-charge "Groceries" 20))  false customer2)))

(check-expect (increase-limit customer5 3011 500)
                        (make-customer 3011 (make-contact "Billy" "29 Smith St" "billy01@gmail.com") 1409.7
                        (list (make-charge "Gaming" 849) (make-charge "Theater" 20))  customer3 customer4))
...
;;  consumes a BST, a natural, and a contact info and produces a BST with an added
;; user with the given information and a limit of 2500

(define (add-customer atn ccn contact)
   (cond [(boolean? atn) (make-customer ccn contact 25000 empty false false)]
         [(customer? atn)
          (cond
                [
                                (> (customer-card-number  atn) ccn)
                  (make-customer (customer-card-number atn)
                             (customer-contact atn)
                             (customer-limit atn)
                             (customer-charges atn)
                             (add-customer (customer-left atn) ccn contact)
                             (customer-right atn))]
                 ...
                 [ (< (customer-card-number atn) ccn)
                  ...
                  (make-customer (customer-card-number atn)
                             ...
                             (customer-charges atn)
                             (customer-left atn)
                             (add-customer (customer-right atn) ccn contact))]
...
(check-expect (add-customer customer5 500 CONTACT1)
              (make-customer 3011 (make-contact "Billy" "29 Smith St" "billy01@gmail.com") 909.7
                        (list (make-charge "Gaming" 849) (make-charge "Theater" 20))
                        (make-customer 2049 (make-contact "Nate" "13 Smith St" "nate01@gmail.com") 403.4
                        (list (make-charge "Software" 199) (make-charge "Gaming" 849) (make-charge "Theater" 20))
                        (make-customer 1001 CONTACT1 185.8 L1
                                       (make-customer 500 CONTACT1 25000 empty false false) false) false)
                        customer4))

(check-expect (add-customer customer5 6000 CONTACT2)
              (make-customer 3011 (make-contact "Billy" "29 Smith St" "billy01@gmail.com") 909.7
                        (list (make-charge "Gaming" 849) (make-charge "Theater" 20))
                        (make-customer 2049 (make-contact "Nate" "13 Smith St" "nate01@gmail.com") 403.4
                        (list (make-charge "Software" 199) (make-charge "Gaming" 849) (make-charge "Theater" 20))
                        (make-customer 1001 CONTACT1 185.8 L1
                                       false false) false)
                        (make-customer 4049 (make-contact "Zack" "26 Smith St" "zack01@gmail.com") 608.7
                        (list (make-charge "Software" 269) (make-charge "Video Games" 549) (make-charge "Groceries" 20))  false
                        (make-customer 5029 CONTACT2 203.9 L2 false
                                                                                                                                               (make-customer 6000 CONTACT2 25000 empty false false)))))

(check-expect (add-customer false 1 CONTACT1) (make-customer 1 CONTACT1 25000 empty false false))


(check-expect (add-customer customer5 3500 CONTACT2)
              (make-customer 3011 (make-contact "Billy" "29 Smith St" "billy01@gmail.com") 909.7
                        (list (make-charge "Gaming" 849) (make-charge "Theater" 20))
                        (make-customer 2049 (make-contact "Nate" "13 Smith St" "nate01@gmail.com") 403.4
                        (list (make-charge "Software" 199) (make-charge "Gaming" 849) (make-charge "Theater" 20))
                        (make-customer 1001 CONTACT1 185.8 L1
                                       false false) false)
                        (make-customer 4049 (make-contact "Zack" "26 Smith St" "zack01@gmail.com") 608.7
                        (list (make-charge "Software" 269) (make-charge "Video Games" 549) (make-charge "Groceries" 20))  (make-customer 3500 CONTACT2 25000 empty false false)
                        (make-customer 5029 CONTACT2 203.9 L2 false
                                                                                                                                               false))))
